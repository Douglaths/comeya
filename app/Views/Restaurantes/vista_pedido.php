...
<head>
    ...
    <title>Confirmar Pedido - <?= $restaurante['nombre'] ?></title>
...
<body>
        ...
        <div class="confirm-content">
            ...
            <div class="summary-box">
                ...
                <?php if (!empty($carrito)): ?>
                    <?php foreach ($carrito as $item): ?>
                        <div class="summary-item">
                            ...
                            <span class="summary-item-price">€<?= number_format($item['precio'] * $item['cantidad'], 2) ?></span>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="summary-item">
                ...
                <div class="summary-total">
                    ...
                    <span class="summary-total-price">€<?= number_format($total ?? 18.40, 2) ?></span>
                </div>
            </div>

            <!-- Información del Pedido -->
            <form id="orderForm" method="post" action="<?= base_url('restaurantes/procesar_pedido') ?>">
                <div class="summary-box">
                    ...
                    <input type="hidden" name="empresa_id" value="<?= $restaurante['id'] ?? 1 ?>">
                    <input type="hidden" name="total" value="<?= $total ?? 18.40 ?>">
                </div>

                <button type="button" class="btn-confirm" onclick="confirmOrder()">Confirmar Pedido</button>
            </form>
        </div>
    </div>
    ...
    <script>
        function goBack() {
            window.location.href = '<?= base_url('restaurantes/menu/' . ($restaurante['id'] ?? 1)) ?>';
        }
            ...
            document.querySelector('.confirm-content').innerHTML = `
                ...
                <div class="summary-box">
                    ...
                    <div style="display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid #e9ecef;">
                        ...
                        <span style="font-weight: 600;"><?= esc($restaurante['nombre'] ?? 'La Parrilla Dorada') ?></span>
                    </div>
                    <div style="display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid #e9ecef;">
                        <span>Total</span>
                        <span style="font-weight: 700;">€<?= number_format($total ?? 18.40, 2) ?></span>
                    </div>
