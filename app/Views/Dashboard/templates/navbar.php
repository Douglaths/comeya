                ...
                <ul class="navbar-nav iq-main-menu">
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon text-primary">Panel Super Admin</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('public/superadmin/analytics') ?>">
                            ...
                            <span class="item-name">Visitas / Analytics</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-marketing" role="button" aria-expanded="false" aria-controls="sidebar-marketing">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M2 17L12 22L22 17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="item-name">Marketing & Publicidad</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-marketing" data-bs-parent="#sidebar">
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url('public/superadmin/publicidad') ?>">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Publicidad</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon text-primary">Sistema</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>
