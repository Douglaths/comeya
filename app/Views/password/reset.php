...
<head>
    ...
    <title>Nueva Contraseña - comeya</title>
                    ...
                    <div class="col-lg-5 col-md-8">
                        <div class="card" style="transform: translate(0px, 25px);">
                            <div class="card-header">
                                ...
                                <h5 class="text-center mt-3">Nueva Contraseña</h5>
                                <p class="text-center text-muted">Ingresa tu nueva contraseña para <?= esc($email) ?></p>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="<?= base_url('password/update') ?>" method="POST">
                                    ...
                                    <button type="submit" class="btn text-white w-100 mb-3" style="background-color: #ff6b35;">Actualizar Contraseña</button>
