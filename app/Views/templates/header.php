...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= base_url('assets/images/logos/ico.png') ?>">
  <!-- CSS Locales -->
  ...
  <header class="hero-header text-center position-relative">
    <div class="container">
      ...
      <img src="<?= base_url('assets/images/logos/logo.png') ?>" alt="Logo" class="mb-4 logo-responsive">
